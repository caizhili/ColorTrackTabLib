...
//    private int scrollOffset = 20;
    ...
    private int textOriginColor = 0x000000;
    private int textChangeColor = 0xff0000;

    private int tabTextSize = 12;
    private int tabTextColor = Color.RED;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        textOriginColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsColorTrackOriginColor,textOriginColor);
        textChangeColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsColorTrackChangeColor,textChangeColor);
        tabTextSize = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_psts_text_size,scrollOffset);
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (pager.getAdapter() instanceof IconTabProvider) {
                ...
                addColorTrackTextTab(i, pager.getAdapter().getPageTitle(i).toString(),textOriginColor,textChangeColor);
//                addTextTab(i, pager.getAdapter().getPageTitle(i).toString());
    ...
    private void addColorTrackTextTab(final int position, String title,int textOriginColor,int textChangeColor){
        ColorTrackView colorTrackView = new ColorTrackView(getContext(),tabTextSize,textOriginColor,textChangeColor);
        colorTrackView.setText(title);
        addTab(position, colorTrackView);
    }
...
//        if (tabCount <= 4) {
//            tab.setWidth(ScreenUtil.screenWidth / tabCount);
//        }
...
//                }
            ...
            }else if(v instanceof ColorTrackView){
...
//                setScrollOffset((ScreenUtil.screenWidth - colorTrackView.getWidth()) / 2);    //设置选中项的位置（包括下划线）
    ...
    private void changeColorTrackViewColor(int index) {
        for (int i = 0; i < tabCount; i++) {
            if(tabsContainer.getChildAt(i) instanceof  ColorTrackView) {
